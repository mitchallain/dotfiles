" note this is taken from the plugin vimux-pyutils
" https://github.com/julienr/vimux-pyutils/blob/master/ftplugin/python/pyutils.vim
...
def send_to_tmux(lines):
  ...
  if vim.eval("g:vimux_pyutils_use_tslime") == "1":
    ...
    lines_step = 20
    for i in range(0, len(lines), lines_step):
...
" these are vimux-pyutils defaults, but I don't like them
